...
\begin{center}
\only<2>{\includegraphics[width=0.9\textwidth]{graphics/H-4-1.png}}
\only<3>{\includegraphics[width=0.9\textwidth]{graphics/H-8-1.png}}
\only<4>{\includegraphics[width=0.9\textwidth]{graphics/H-8-8.png}}
\only<5>{\includegraphics[width=0.9\textwidth]{graphics/H-64-1.png}}
\end{center}
\end{frame}
