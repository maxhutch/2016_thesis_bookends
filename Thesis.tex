...
\abstract{
\addtocontents{toc}{\vspace{1em}}  % Add a gap in the Contents, for aesthetics
The Rayleigh-Taylor instabilitiy is one of the most common and well studied phenomena in fluid dynamics. 
...
It was recently demonstrated in this, the low-Atwood regime, that the model single-mode problem departs from established potential flow models in the form of a re-acceleration beyond the predicted terminal interface velocity.
...
The approach taken here is based on buoyancy-drag models, which express a force balance between buoyancy and parastic drag.
The dynamical buoyancy-drag model is supplemented with a mixing model that dillutes the buoyant force over time.
...
The remaining 5 coefficientss are estimated by relating them to drag coefficients, friction factors, and geometric ratios in the interface shape.
...
I thank Aleksandr Obabko and Paul Fischer for supporting Nek5000 and working through the numerics with me.
